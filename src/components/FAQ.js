    ...
    return (
      <section className='faq' id='faq'>
        ...
        <div className='faq__container'>
          ...
          {this.state.btn1 && <p className='faq__answer'>Lorem ipsum lorem ipsum Lorem ipsum lorem ipsum Lorem ipsum lorem ipsum </p>}
        </div>
        <div className='faq__container'>
          <button className='faq__btn'>
            How can I request a new browser?<img src={arrow} alt=''></img>
          </button>
          {this.state.btn2 && <p className='faq__answer'>Lorem ipsum lorem ipsum</p>}
        </div>
        <div className='faq__container'>
          <button className='faq__btn'>
            Is there a mobile app?<img src={arrow} alt=''></img>
          </button>
          {this.state.btn3 && <p className='faq__answer'>Lorem ipsum lorem ipsum</p>}
        </div>
        <div className='faq__container'>
          <button className='faq__btn'>
            What about Chromium browsers?<img src={arrow} alt=''></img>
          </button>
          {this.state.btn4 && <p className='faq__answer'>Lorem ipsum lorem ipsum</p>}
        </div>
